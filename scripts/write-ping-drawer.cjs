  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <TAG_DIV className="px-6 pt-5">
          <TAG_DIV className="mb-6 flex justify-center">
            <TAG_DIV className="inline-flex items-center gap-2 rounded-full border border-blue-500/20 bg-blue-500/10 px-4 py-2">
          ...
          <TAG_DIV className="mb-6 rounded-2xl border border-slate-700/50 bg-slate-900/60 p-5 backdrop-blur-md">
            <TAG_DIV className="mb-4 border-b border-dashed border-slate-700 pb-3">
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">
                Escrow Receipt
              </p>
            </TAG_DIV>

            <TAG_DIV className="space-y-4 font-mono text-sm">
              <TAG_DIV className="flex items-center justify-between">
              ...
              <TAG_DIV className="border-t border-dashed border-slate-600 pt-4">
                <TAG_DIV className="flex items-center justify-between">
                  <TAG_DIV className="flex items-center gap-2">
          ...
          <TAG_DIV className="mb-6 flex items-center justify-center gap-2 text-sm text-slate-400">
            <TAG_DIV className="flex -space-x-2">
              {[...Array(3)].map((_, index) => (
                <TAG_DIV
                  key={index}
                  className={cn(
              ...
              <TAG_DIV className="flex h-8 w-8 items-center justify-center rounded-full border-2 border-slate-950 bg-slate-700">
          ...
          {statusMessage ? (
            ...
            >
              {isSent ? (
                <TAG_DIV className="flex items-center justify-center gap-2">
...
fs.writeFileSync(
  "C:/Users/hkathuria/Downloads/poolpay/components/ping-drawer.tsx",
  content.replace(/TAG_DIV/g, "motionlessdiv").replace(/motionlessmotionlessdiv/g, "motionlessmotionlessmotionlessmotionlessdiv")
);
