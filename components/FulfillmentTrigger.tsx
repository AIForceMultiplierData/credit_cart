...
export function FulfillmentTrigger({
  ...
  if (status === "order_placed") {
    return (
      <div className="mt-4 rounded-2xl border border-blue-500/20 bg-slate-900/50 p-4 backdrop-blur-md">
        ...
        <div className="space-y-3">
          <div className="rounded-xl border border-slate-700/60 bg-slate-950/50 px-3 py-3">
  ...
  return (
    <div className="mt-4 rounded-2xl border border-blue-500/30 bg-slate-900/50 p-4 backdrop-blur-md">
      <div className="mb-3 flex items-center gap-2">
      ...
      <div className="space-y-3">
        ...
        <AnimatePresence initial={false}>
          {addressRevealed && (
            ...
            >
              <div className="rounded-xl border border-slate-700/60 bg-slate-950/60 px-3 py-3">
                <p className="text-xs uppercase tracking-wide text-slate-500">
