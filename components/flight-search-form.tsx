  ...
  return (
    <div className="space-y-3">
      ...
      <div
        className={cn(
          "grid gap-2",
          params.tripType === "return" ? "grid-cols-1 sm:grid-cols-2" : "grid-cols-1"
        )}
      >
        <DatePickerField
      ...
      <div>
        <Label className="mb-2 text-[10px] uppercase tracking-wide text-slate-500">
          Departure time
        </Label>
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        ...
        >
          <SelectTrigger className="h-11 w-full border-slate-700 bg-slate-950 sm:w-[160px]">
