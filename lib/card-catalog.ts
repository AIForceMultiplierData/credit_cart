...
const RAW_CATALOG: Omit<CatalogCard, "bank_logo_url" | "card_image_url">[] = [
  ...
  {
    card_id: "hdfc_bizgrow",
    bank_name: "HDFC",
    card_name: "BizGrow",
    style_classes: "bg-gradient-to-br from-blue-900 to-indigo-950 text-blue-100",
    apply_url: "https://www.hdfc.bank.in/credit-cards",
  },
  {
    card_id: "hdfc_iocl",
    bank_name: "HDFC",
    card_name: "IndianOil",
    style_classes: "bg-gradient-to-br from-amber-700 to-orange-950 text-amber-100",
    apply_url: "https://www.hdfc.bank.in/credit-cards",
  },
  {
    card_id: "hdfc_irctc",
    bank_name: "HDFC",
    card_name: "IRCTC",
    style_classes: "bg-gradient-to-br from-sky-700 to-blue-950 text-sky-100",
    apply_url: "https://www.hdfc.bank.in/credit-cards",
  },
  {
    card_id: "hdfc_pixel_play",
    bank_name: "HDFC",
    card_name: "Pixel Play",
    style_classes: "bg-gradient-to-br from-cyan-600 to-blue-900 text-cyan-100",
    apply_url: "https://www.hdfc.bank.in/credit-cards",
  },
  {
